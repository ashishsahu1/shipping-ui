  ...
  return (
    <>
      ...
      <button
         ...
         <h2 className='text-left mt-4 ml-32 text-2xl font-semibold mb-1 pb-1'>Lorem ipsum dolor sit.</h2>
      <div className='flex flex-col md:flex-row container mx-auto p-4'>
        ...
        <div className='flex justify-evenly xl:w-4/6 md:w-7/10 w-full bg-white p-16 rounded-lg shadow-xl md:mr-4'>
         ...
         <div className="content-txt">
            ...
            <button onClick={()=>{navigate('/resultload')}} className='bg-[#F26A23] hover:bg-orange-700 text-white font-bold py-2 px-4 rounded ml-4 mt-6 w-3/4 right'>
                Get Quote
              </button>
         </div>
