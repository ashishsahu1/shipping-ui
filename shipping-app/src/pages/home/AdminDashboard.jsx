      ...
      <div className='flex'>
        ...
        <div className='w-3/4 p-4'>
          ...
          <div className='flex space-x-4 mb-4'>
            <div className='w-1/2 p-4 py-8 bg-white rounded-lg shadow-md flex'>
              <div className='w-3/4'>
          ...
          <div className='flex space-x-4 my-8'>
            ...
            <div className='w-1/3 p-4 bg-white rounded-lg shadow-md'>
              ...
              <div className="flex justify-between"><p className='text-center'>Pie Chart View</p>
              <a href='/more' className='text-center text-blue-500 block'>See more</a></div>
              
            </div>
            <div className='w-1/3 p-4 bg-white rounded-lg shadow-md'>
              <img src='/line.png' alt='Line Chart' className='w-full h-auto mb-2' />
              <div className="flex justify-between"><p className='text-center'>Line Chart View</p>
              <a href='/more' className='text-center text-blue-500 block'>See more</a></div>
          ...
          <div className='flex space-x-4 mb-4'>
            <div className='w-1/2 p-4 bg-white rounded-lg shadow-md flex'>
              <div className='w-3/4'>
          ...
          <div className='flex space-x-4 mb-4'>
           <div className='w-1/2 p-4 bg-white rounded-lg shadow-md flex gap-4'>
                <div className='w-1/4 flex justify-end items-center'>
             ...
             <div className=" w-3/4 flex flex-col gap-4">
              ...
              <button
                className='bg-[#F26A23] hover:bg-orange-700 text-white font-bold py-2 px-4 rounded w-40 '>
                Buttons
              </button>
             </div>
