    ...
    <>
      ...
      <div className='flex flex-col md:flex-row container mx-auto p-4'>
        ...
        <div className='xl:w-4/6 md:w-7/10 w-full bg-white p-8 rounded-lg mt-10 shadow-md md:mr-4 flex flex-col'>
          <h2 className='text-left text-2xl font-semibold mb-4 pb-4'>
            Company Details
          </h2>
          ...
          <form className=''>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 flex-grow'>
              ...
              <div>
                <label className='block text-gray-700 mb-2'>Customer Tax ID</label>
                <input type='text' className='w-full p-2 border rounded mb-4' />
              </div>
              <div>
                <label className='block text-gray-700 mb-2'>
          ...
          <div className='flex justify-end mt-4'>
            <button
              ...
              className='bg-[#F26A23] hover:bg-orange-700 text-white font-bold py-3 px-4 rounded w-full'>
              Create Account
            </button>
          </div>
        </div>
